        ...
        <Box display="flex" py={4} alignItems="center">
            ...
            {isSmallScreen ?
                <>
                    ...
                    <NavLink to="/contact" className={(navData) => (navData.isActive ? "active" : 'none')}><IconButton title="Contact"> <Person2 /> </IconButton></NavLink>
                </>
                :
                <>
                    ...
                    <NavLink to="/contact" className={(navData) => (navData.isActive ? "active" : 'none')}><Button>Contact</Button></NavLink>
                </>
                }
